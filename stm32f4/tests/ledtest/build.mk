...
stm32f4/tests/ledtest/ledtest: OBJECTS := $(ledtest_OBJECTS)
...
stm32f4/tests/ledtest/ledtest: $(ledtest_OBJECTS)
	$(CC) -o $@ $(LDFLAGS) -Wl,-Map=$@.map $(ledtest_OBJECTS) $(ledtest_LIBS)

stm32f4/tests/ledtest/ledtest.bin: stm32f4/tests/ledtest/ledtest
	$(OBJCOPY) -O binary $< $@

all: stm32f4/tests/ledtest/ledtest.bin
